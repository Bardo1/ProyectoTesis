...
$Correobuscado=$Logica->BuscarClaveRegistro($Correo1);

   if($Correobuscado!=null){


  //Enviar clase email correo electronico con parametro
   }else{

  //El correo electronico no ha sido encontrado dentro de los registros del sismtema  
  }
...
?> 
<script>
alert('Se ha enviado una copia de la clave secreta a su cuenta de correo electronico. Reviselo.');
</script>
<?php
}
?>
...
<div class="control-group">
   <label>Enviar copia de clave a su correo electronico registrado en la pagina</label>
  <label class="control-label" for="textinput">Ingrese su correo</label>
  <div class="controls">
    <input id="Correo" name="Correo" type="text" placeholder="@" class="input-xlarge" required="">
