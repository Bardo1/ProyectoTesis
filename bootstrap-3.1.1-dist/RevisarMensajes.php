...
$ListaDeMensajes = $Logica->BuscarMensajes();
 if($ListaDeMensajes!=null){
  foreach ($ListaDeMensajes as $Mensaje){
?> 
 <div class="col-sm-12">
    <div class="row">
      <div class="col-xs-12">
        <h><?php echo $Mensaje->GetFechaMes();?></h>
        <h><?php echo $Mensaje->GetFechaDia();?></h>  
          <h><?php echo $Mensaje->GetFechaAnio();?></h>
        <p><?php echo $Mensaje->GetMensaje();?></p>
