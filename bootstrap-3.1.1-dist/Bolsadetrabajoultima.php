...
<form class="navbar-form navbar-left" role="search">
  ...
  <br> </br>
        ...
        <button type="submit" class="btn btn-default">Buscar Ofeta</button>
 </form>
...
$ListaDeOfertas = $Logica->BuscarListaOfertas();
 if($ListaDeOfertas!=null){
  foreach ($ListaDeOfertas as $OfertaLaboral){
?> 
  <!--center-->


  <form method="post" action="OfertaDesplegada.php"> 
  ...
  <div class="col-sm-12">
    <div class="row">
      <div class="col-xs-12">
        <p id="Mes1" name="Mes1" value='asdad'><?php echo $OfertaLaboral->GetFechaMes();?></p>
        <p id="Dia1" name="Dia1"><?php echo $OfertaLaboral->GetFechaDia();?></p>
        <h id="Anio1" name="Anio1"><?php echo $OfertaLaboral->GetFechaAnio();?></h>
        <p id="Descrip" name="Descrip"><?php echo $OfertaLaboral->GetDescripcion();?></p>
        <p id="Bene" name="Bene"><?php echo $OfertaLaboral->GetBeneficios();?></p>
        <p id="Ubi" name="Ubi"><?php echo $OfertaLaboral->GetUbicacion();?></p>
        <p id="Requi" name="Requi"><?php echo $OfertaLaboral->GetRequisitos();?></p>     
         <p><a class="btn" href="#">Ver detalle &raquo;</a></p>
      </div>
    </div>
...
?>
   <p>No se han encontrado mensajes en la base de datos</p>
   <?php  
}
?>
