...
<html lang="en">
    ...
    <head>
        ...
        <link href="C:\wamp2\www\bootstrap-3.1.1-dist\css/bootstrap.min.css" rel="stylesheet">
        <link href="C:\wamp2\www\bootstrap-3.1.1-dist\css/bootstrap.css" rel="stylesheet">
        <link href="C:\wamp2\www\bootstrap-3.1.1-dist\bootstrap-social-gh-pages\bootstrap-social.css" rel="stylesheet">
         <link href="C:\wamp2\www\bootstrap-3.1.1-dist\bootstrap-social-gh-pages\bootstrap-social.less" rel="stylesheet">
        <!--[if lt IE 9]>
          <script src="//html5shim.googlecode.com/svn/trunk/html5.js"></script>
        <![endif]-->
      
        <!-- link botones sociales el link y el script -->
        <link rel="stylesheet" href="C:\wamp2\www\bootstrap-3.1.1-dist\css/style.css">
...
color:#000000;
    ...
    <body background="C:\wamp2\www\bootstrap-3.1.1-dist\bg-11-full.jpg" background-attachment: fixed; 
  ...
  <div class="container">
    <div class="navbar-header">
        <a class="navbar-brand logo-nav" href="index.php">
                    <img  border="0" height="90" width="200" src="C:\wamp2\www\bootstrap-3.1.1-dist\logo1.png">
                </a>
