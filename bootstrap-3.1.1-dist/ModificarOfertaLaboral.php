...
<html lang="en">
    ...
    <head>
        ...
        <link href="C:\Users\walter\Desktop\bootstrap-3.1.1-dist\css/bootstrap.min.css" rel="stylesheet">
        <link href="C:\Users\walter\Desktop\bootstrap-3.1.1-dist\css/bootstrap.css" rel="stylesheet">
        <link href="C:\Users\walter\Desktop\bootstrap-3.1.1-dist\bootstrap-social-gh-pages\bootstrap-social.css" rel="stylesheet">
         <link href="C:\Users\walter\Desktop\bootstrap-3.1.1-dist\bootstrap-social-gh-pages\bootstrap-social.less" rel="stylesheet">
        <!--[if lt IE 9]>
          <script src="//html5shim.googlecode.com/svn/trunk/html5.js"></script>
        <![endif]-->
      
        <!-- link botones sociales el link y el script -->
        <link rel="stylesheet" href="C:\Users\walter\Desktop\bootstrap-3.1.1-dist\css/style.css">
...
color:#000000;
    ...
    <body background="C:\Users\walter\Desktop\bootstrap-3.1.1-dist\bg-11-full.jpg" background-attachment: fixed; 
...
if (isset($_POST['BuscarOfer'])) {
$Codigo=$_POST['CodigoOfer'];
$Logica= new ClaseLogica();
$Oferta=$Logica->BuscarOfertaLaboral($Codigo);

$dia1=$Oferta->Getfdia();
$mes1=$Oferta->Getfmes();
$anio1=$Oferta->Getfanio();
  ...
  <div class="container">
    <div class="navbar-header">
        <a class="navbar-brand logo-nav" href="index.php">
                    <img  border="0" height="90" width="200" src="C:\Users\walter\Desktop\bootstrap-3.1.1-dist\logo1.png">
                </a>
...
<!-- Form Name -->
<legend>Modificar Oferta Laboral</legend>

<!-- Text input-->
<div class="control-group">
  <label class="control-label" for="textinput">Ingrese codigo de oferta</label>
  <div class="controls">
...
<div class="control-group">
 ...
 <p><strong>Fecha para publicacion: <?php ?></strong>
                <script>
...
document.write(f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
              ...
              <p><strong>Fecha que se publicó oferta:</strong><?php echo $dia1." de ".$mes1." de ".$anio1?></p>
...
<div class="control-group">
  ...
  <div class="controls">
    <button id="button1id" name="button1id" class="btn btn-success">Ingresar Oferta</button>
...
<br> </br>
 ...
 <footer style="background-color:#000000;clear:both;text-align:center";
    ...
    <script src="C:\Users\walter\Desktop\bootstrap-3.1.1-dist\js/bootstrap.min.js"></script>
